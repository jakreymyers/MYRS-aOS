---
name: open-prose
description: OpenProse is a programming language for AI sessions and this skill intelligently interprets what the user wants. Activate on ANY `prose` command (prose boot, prose run, prose compile, prose update, etc.), running .prose files, mentioning OpenProse/Prose, or orchestrating multi-agent workflows.
---
